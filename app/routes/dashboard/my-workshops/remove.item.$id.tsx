...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  // try to get workshop item and check if it ours
...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const workshopItem = await workshopItemModel.exists({ id: params.id as string, userId: await sessionService.getUserId(request) });
  if (!workshopItem)
...
export default function RemoveMyWorkshopItem() {
