...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  return redirect("/dashboard/admin/product-categories/edit/" + params.id + "/products?productRemoved=true");
...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const product = await productModel.getById(params.productId as string);
  if (!product)
    return redirect("/dashboard/admin/product-categories/edit/" + params.id + "/products");
...
export default function RemoveProduct() {
  ...
  const handleCancel = () => {
    navigate("/dashboard/admin/product-categories/edit/" + id + "/products");
  }
