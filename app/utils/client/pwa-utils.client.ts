...
/*export function checkIfPushIsEnabled(setStatus: any) {
...
export function subscribeToPushNotification(setStatus: any) {
  navigator.serviceWorker.ready
  .then(function(registration) {
...
export function unsubscribeFromPushNotification(setStatus: any) {
  navigator.serviceWorker.ready
  .then(function(registration) {
      registration.pushManager.getSubscription()
      .then(function (subscription) {
