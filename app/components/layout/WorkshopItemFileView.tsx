...
export default function WorkshopItemFileView({name, title, type, language, id, workshopItemId }: Props) {
      ...
      <div className="ml-auto">
        { user?.permissions[PermissionName.adminWorkshopsEdit] && (
          <Button
            ...
            size="xs"
            variant="danger"
            to={`/dashboard/admin/workshops/edit/item/${workshopItemId}/files/remove/${id}`}
            icon={FaTimes}
          >
            {t("common.remove")}
          </Button>
